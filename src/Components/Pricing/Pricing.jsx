    ...
    <div className="my-28 max-w-7xl mx-auto px-6">
      ...
      <div className="card-section grid grid-cols-3 gap-10">
        <div className="card border border-gray-200 rounded-xl bg-base-300 py-6 px-6 space-y-7 relative">
          ...
          <button className="btn btn-primary rounded-3xl w-80 absolute bottom-5 right-7">
            Get Started Free
          </button>
        </div>
        <div className="card border border-gray-200 rounded-xl bg-[#9514FA] text-white py-6 px-6 space-y-7 relative">
          <p className="absolute left-35 -top-5 text-center text-sm bg-amber-100 text-amber-500 p-2 rounded-3xl w-[120px]">
            Most Popular
          </p>
          <div>
          ...
          <button className="btn rounded-3xl w-80 absolute bottom-5 right-7 text-[#9514FA]">
            Start Pro Trial
          </button>
        </div>
